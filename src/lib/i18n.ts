...
export const translations = {
  ar: {
    ...
    heroDescription: 'تطبيق يربط المراجع والطبيب: حجز مواعيد، متابعة التفاصيل، محادثة ،تقارير , ادارة العيادة بشكل احترافي وإدارة الحساب.',
    ...
    featureE2eeTitle: 'تقارير اكسل',
    featureE2eeDesc: 'يمكنك تحميل تقارير المواعيد والبيانات بصيغة Excel مباشرة من النظام.',
    featureE2eeBullets: [
      'تحميل تقرير يومي أو شهري (Excel)',
      'تصدير بيانات المواعيد بسهولة',
    ...
    featureAccountDesc: 'تحديث المعلومات الشخصية، ، حذف الحساب، وسجل نشاط (عند توفره).',
